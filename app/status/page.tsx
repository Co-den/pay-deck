...
const incidents = [
  {
    ...
    status: "resolved",
    duration: "30 minutes",
    description: "Database optimization and infrastructure updates completed successfully.",
  },
  {
    date: "2024-12-25",
    ...
    status: "resolved",
    duration: "2 hours",
    description: "Network routing issue affecting API response times. Problem identified and resolved.",
  },
  {
    date: "2024-12-20",
    ...
    status: "resolved",
    duration: "15 minutes",
    description: "Brief intermittent access issue to merchant dashboard. Service restored.",
  },
]
    ...
    <>
      ...
      <div className="min-h-screen bg-background">
        <div className="container py-12">
          <div className="mb-12">
            <h1 className="text-4xl font-bold tracking-tight mb-2">PayDeck Status</h1>
            <p className="text-lg text-muted-foreground">System performance and incident history</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-500/10 to-green-500/5 border border-green-500/20 rounded-lg p-6 mb-12">
            ...
            <p className="text-muted-foreground">Last updated: {new Date().toLocaleString()} • 30-day uptime: 99.98%</p>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {systemStatus.map((component) => (
                <div key={component.service} className="border border-border rounded-lg p-4">
